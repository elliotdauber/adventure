...
function showCharacterChoiceScreen() {
	...
	colorText("Game Mode:", OSC.GAMEMODE_BOX_X-5, OSC.GAMEMODE_BOX_Y-20, "#E0E0E0")
	colorRect(OSC.GAMEMODE_BOX_X, OSC.GAMEMODE_BOX_Y, OSC.GAMEMODE_BOX_W, OSC.GAMEMODE_BOX_H, gameModeButtonColor);
	colorText(gameMode, OSC.GAMEMODE_BOX_X+OSC.GAMEMODE_BOX_W-35-gameMode.length*15, OSC.GAMEMODE_BOX_Y+33, "#565656");
...
function handleMouseClickOpeningScreen(evt) {
	...
	if (mouseInBounds(mouseX, mouseY, OSC.GAMEMODE_BOX_X, OSC.GAMEMODE_BOX_Y, OSC.GAMEMODE_BOX_W, OSC.GAMEMODE_BOX_H)) {
		if (gameMode == "story") {
			gameMode = "random";
		} else {
			gameMode = "story";
...
function handleMousemoveOpeningScreen(evt) {
	...
	if (mouseInBounds(mouseX, mouseY, OSC.GAMEMODE_BOX_X, OSC.GAMEMODE_BOX_Y, OSC.GAMEMODE_BOX_W, OSC.GAMEMODE_BOX_H)) {
		gameModeButtonColor = characterChoiceChosenColor;
	} else {
		gameModeButtonColor = characterChoiceUnchosenColor;
	}
